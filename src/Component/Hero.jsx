    ...
    <section id="Home" className="border-b border-neutral-900 pb-4 lg:mb-35">
        <section className="flex flex-wrap">
            ...
            <section className="flex flex-col items-center lg:items-start">
                <motion.h1  variants={container(0.8)} initial="hidden" animate="visible" className="lg:pb-8 pb-2 md:text-5xl text-[1.8em] tracking-tight lg:mt-1 lg:text-7xl">Vishal Kumar <span className="tracking-normal lg:font-thin font-normal   lg:text-neutral-200" >Choudhary</span> </motion.h1>
